...
public class CreateServiceInstanceBindingRequest {
	...
	public String toString() {
		return "CreateServiceInstanceBindingRequest [serviceDefinitionId="
				+ serviceDefinitionId + ", planId=" + planId + ", appGuid="
				+ appGuid + ", parameters=" + parameters
				+ ", serviceInstanceId=" + serviceInstanceId + ", bindingId="
				+ bindingId + "]";
	}
