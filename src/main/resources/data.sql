...
insert into plans (name, id, description, service_id, plan_cred_id, metadata_id, is_free) values ('basic', '0ab7a335-b495-3009-ad14-40b06919bf12', 'Basic Plan throttled to 5 connections per second', '3745cb31-64c7-3ba0-a3a8-374c1fe38d98', 'cred1', 1, 1);
insert into plans (name, id, description, service_id, plan_cred_id, metadata_id, is_free) values ('premium', '65040368-a981-31ac-962d-e09d8331a4b8', 'Premium Plan throttled to 25 connections per second', '3745cb31-64c7-3ba0-a3a8-374c1fe38d98', 'cred2', 2, 0);
