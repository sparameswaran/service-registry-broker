...
create table credentials (id integer not null auto_increment, password varchar(255), uri varchar(255) not null, username varchar(255), primary key (id))
...
create table plans (name varchar(255) not null, service_id varchar(255) not null, description varchar(255) not null, isFree bit, plan_cred_id integer, metadata_id integer, primary key (name, service_id))
...
create table services (name varchar(255) not null, bindable bit not null, description varchar(255) not null, metadata_id integer, primary key (name))
...
alter table plans add constraint FK_med4ruw2v39cdl5flp25nglr3 foreign key (service_id) references services (name)
