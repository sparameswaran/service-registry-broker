...
(function () {
    ...
    var AddServices = React.createClass({
        ...
        handleSubmit: function (event) {
            ...
            if (this.state.rawValue != undefined) {
            	RegistryServices.postServices(this.state.rawValue);
            } else {
                var space = '\t';
                var oldValue = JSON.stringify(this.state.value, undefined, space);
            	RegistryServices.postServices(oldValue);
            }
