...
(function () {
    ...
    var CredentialEditor = React.createClass({
        getInitialState: function () {
            ...
            var credentialsList = [
                {
                    cname: "testurl",
                    cvalue: "http://www.test.com"
                }
            ];

            RegistryServices.getCredentialsForPlans(this.props.planId)
                .done(this.mapCredentials);
            return {
                credentialEntrylist: credentialsList
            };
        },
        ...
        mapCredentials: function (credAttribs) {
            ...
            for (var key in credAttribs) {
                credentialEntrylist.push({
                    cname: key,
                    cvalue: credAttribs[key]
                });
            }
            this.setState ({
                credentialEntrylist: credentialEntrylist
            });
        },
        handleNewRowSubmit: function (newcredentialEntry) {
            this.setState({
                credentialEntrylist: this.state
                    .credentialEntrylist
                    .concat([newcredentialEntry])
            });
        },
        handleCredentialEntryRemove: function (credentialEntry) {
            ...
            this.state
                ...
                .splice(index, 1);
            this.setState({
                credentialEntrylist: this.state.credentialEntrylist
            });
        },
        toString: function () {
            var output = {};
    ...
    var CredentialEntryList = React.createClass({
        handleCredentialEntryRemove: function (credentialEntry) {
            this.props
                .onCredentialEntryRemove(credentialEntry);
        },
        render: function () {
            ...
            this
                .props
                .clist
                .forEach(function (credentialEntry) {
    ...
    var CredentialEntry = React.createClass({
        handleRemoveCredentialEntry: function () {
            this.props
                .onCredentialEntryDelete(this.props.credentialEntry);
            return false;
        },
        render: function () {
            return (
                <tr>
                    ...
                    <td>
                        <DefaultButton className="btn btn-primary  type-error-4" onClick={this.handleRemoveCredentialEntry}>
                            Remove
                        </DefaultButton>
                    </td>
                </tr>
        ...
        render: function () {
            ...
            return (
                <div className="well">
                    ...
                    <div className="input-group input-group-lg" style={inputStyle}>
                        <DefaultButton type="submit" className="btn btn-primary" onClick={this.handleSubmit}>Add Entry
                        </DefaultButton>
                    </div>
