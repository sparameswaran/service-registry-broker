...
(function () {
  ...
  var EditService = React.createClass({
	...
	getInitialState: function() {
        ...
        RegistryServices.findServiceById(serviceId).done(this.reloadService);
	  ...
	  handleSubmit: function(event) {
	    ...
	    var longDescription = this.refs.longDescription.getDOMNode().value;
	    var providerDisplayName = this.refs.providerDisplayName.getDOMNode().value;
	    var documentationUrl = this.refs.documentationUrl.getDOMNode().value;
	    var supportUrl = this.refs.supportUrl.getDOMNode().value;
              ...
              <div className="media-body">
                    ...
                    <p className='h1 type-dark-1 mvn em-low'>Service Editor</p>
 			        ...
 			        <form id="outerForm" role="form">
			            ...
			            <br/>
			            <label for="description"><h4>Display name</h4></label>
			            ...
			            <br/>			            
			            <label for="description"><h4>Long Description</h4></label>
			            ...
			            <br/>
			            <label for="description"><h4>Provider Description</h4></label>
			            ...
			            <br/>
			            <label for="description"><h4>Support Url</h4></label>
