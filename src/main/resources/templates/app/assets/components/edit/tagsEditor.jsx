...
(function () {
    ...
    var TagsEditor = React.createClass({
        getInitialState: function () {
            ...
            return {
                tagEntrylist: this.props.tags
            };
        },
        handleNewRowSubmit: function (newtagEntry) {
            this.setState({
                tagEntrylist: this.state
                    .tagEntrylist
                    .concat([newtagEntry])
            });
        },
        handleTagsEntryRemove: function (tagEntry) {
            ...
            this.state
                ...
                .splice(index, 1);
            this.setState({
                tagEntrylist: this.state.tagEntrylist
            });
        },
    ...
    var TagsEntry = React.createClass({
        handleRemoveTagsEntry: function () {
            this.props
                .onTagsEntryDelete(this.props.tagEntry);
            return false;
        },
        render: function () {
            return (
                <tr>
                    ...
                    <td>
                        <DefaultButton type="button" className="btn btn-primary  type-error-4" onClick={this.handleRemoveTagsEntry}>
                            Remove
                        </DefaultButton>
                    </td>
                </tr>
        ...
        render: function () {
            ...
            return (
                <div className="well">
                    ...
                    <div className="input-group input-group-lg" style={inputStyle}>
                        <DefaultButton type="submit" className="btn btn-primary" onClick={this.handleSubmit}>
                            Add Tags
                        </DefaultButton>
                    </div>
                </div>
