...
(function () {
    ...
    var TestPlan = React.createClass({
            ...
            for (var ref in this.refs) {
                ...
                if (ref.lastIndexOf("creds_", 0) === 0) {
                    ...
                    if (ref.lastIndexOf("creds_name", 0) === 0) {
                        keyArr[index] = this.refs[ref]
                            .getDOMNode()
                            .value;
                        count += 1;
                    } else {
                        valArr[index] = this.refs[ref]
                            .getDOMNode()
                            .value;
                    }
                }
        ...
        updateValue: function (nextValue) {
            ...
            this.setState({
                rawValue: nextValue.target.value
            });
                    ...
                    <div className="container">
                            ...
                            <div className="media-body media-middle">
                                <div className="media">
                                    <div className="media-body media-middle">
                                        ...
                                        <p className='h2 type-dark-1 mvn em-low'>Add new Service Plan
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="media-body media-middle txt-l">
                            ...
                            <p className="type-dark-4 mvn type-sm mtl">
                                <span className="mrl em-alt"></span>
                            </p>
                                ...
                                <label for="costs">
                                    ...
                                    <div align="left">
                                        ...
                                        <div className="input-group col-sm-7" key="units">
                                            Units
                                            <input className="form-control" placeholder="select" list="units" ref="units"/>
                                            <datalist id="units">
                                                <option value="WEEKLY"/>
                                                ...
                                                .map(function (input, index) {
                                                    ...
                                                    return (
                                                        <div className="input-group" key={index}>
                                                            ...
                                                            <span className="input-group-addon" onClick={this
                                                                .removeBulletsInputField
                                                                .bind(this, index)} id={ref}>
                                                ...
                                                .map(function (input, index) {
                                                    ...
                                                    return (
                                                        <div className="input-group" key={index}>
                                                            ...
                                                            <span className="input-group-addon" onClick={this
                                                                .removeCredsInputField
                                                                .bind(this, index)} id={nameref}>
                                                                <i className="fa fa-times"></i>
                                                            </span>
                                                        </div>
                                                    )
