  ...
  (function () {
    ...
    var Services = React.createClass({ displayName: "Services",
      ...
      var self = this;
      var url = "/services/";
      console.log("Going to invoke /services");
      registryServices.findAll().done(function(data){

      console.log("Got data on invoke of /services: " + data);
      self.setState({services: data.services});
          });
      },

      handleClick: function(event) {
       console.log("Clicked on services: " + this.props);
      },
  ...
  handleClick: function(event) {
  console.log("Clicked on serviceList: " + this.props);
    },
  ...
  <div className="pvxl" onClick={this.handleClick}>
  <div className="container">
  <div className="tile-layout-xs-1 tile-layout-sm-2 tile-layout-md-3 tile-gutter tile-layout">
  {services}
  </div>
    </div>
  </div>
  ...
  // end::service-list[]
    ...
    var Service = React.createClass({
      mixins: [Navigation],
      console.info("Inside render, with this: " + this);
      render: function() {
        return (
          <TileLayout.Item>
            <ClickableAltPanel className="mvn" onClick={this.transitionTo.bind(this, '/service', null, null)}>
              <div className="media">
                ...
                <div className="media-body">
                  <h4 className="media-heading em-default type-dark-1"> {this.props.service.name } </h4>
                  <p className='mvn type-sm em-default type-dark-5'> { this.props.service.description  } </p>
                </div>
              </div>
            </ClickableAltPanel>
          </TileLayout.Item>
