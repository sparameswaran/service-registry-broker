...
(function () {
    ...
    var Service = React.createClass({
        ...
        render: function () {
            ...
            return (
                <TileLayout.Item>
                    <ClickableAltPanel className="mvn" onClick={this
                        .transitionTo
                        .bind(this, '/service/' + this.props.id, this.props.services, null)}>
                        <div className="media">
                            <div className="media-left media-middle">

                                {(this.props.metadata.imageUrl != undefined && this.props.metadata.imageUrl != '')
                                    ? <img src={this.props.metadata.imageUrl} height='55' width='55'/>
