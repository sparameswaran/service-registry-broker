              ...
              <div className="media-body media-middle">
                <div className="media">
                  ...
                  <div className="media-body media-middle">
                    ...
                    { (this.props.serviceEntry.metadata.imageUrl != undefined && this.props.serviceEntry.metadata.imageUrl != '') ? <img src={this.props.serviceEntry.metadata.imageUrl} height="55" width="55" /> : '' }
                      </p>
